...
exports.registerUserRules = void 0;
...
exports.registerUserRules = joi_1.default.object({
...
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { error } = yield exports.registerUserRules.validate(req.body, { abortEarly: false });
        if (error != null)
            throw error;
        return next();
    }
